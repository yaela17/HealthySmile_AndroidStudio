...
class Fragment_visualizacion_modelos_3d_caries_dentales : Fragment(R.layout.fragment_visualizacion_modelos_3d_caries_dentales) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sceneView = view.findViewById(R.id.sceneViewCaries)
        loadingView = view.findViewById(R.id.loadingViewCaries)
